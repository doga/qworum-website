...
import langdata from 'https://deno.land/x/lume_langdata@v1.0.6/mod.ts'; // my published lume plugin
import navbardata from 'https://deno.land/x/lume_navbardata@v1.0.5/mod.ts'; // my published lume plugin
